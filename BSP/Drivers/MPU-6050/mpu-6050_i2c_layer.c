                         ...
                         AxisStruct_t *pGyro)
{
    ...
    twiAdap.msgArr[0].buf     = &reg;
    twiAdap.msgArr[0].len     = 1;
    twiAdap.msgArr[0].flags   = TWI_WRITE;
    twiAdap.msgArr[1].buf     = ucRecv;
...
bool MPU6050_WriteReg(uint8_t reg, uint8_t val)
{
    ...
    twiAdap.msgArr[0].buf     = buf;
    twiAdap.msgArr[0].len     = 2;
    twiAdap.msgArr[0].flags   = TWI_WRITE;
    status = TWI_Xfer(&twiAdap, 1, MPU6050_TIMEOUT);
